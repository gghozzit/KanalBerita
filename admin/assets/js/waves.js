              ...
              !(function () {
                ...
                x.Normalizations.registered[t] = function (e, r, n) {
                  switch (e) {
                    ...
                    case 'inject':
                      return (
                        8 >= f ? 4 === n.split(' ').length && (n = n.split(/\s+/).slice(0, 3).join(' ')) : 3 === n.split(' ').length && (n += ' 1'), (8 >= f ? 'rgb' : 'rgba') + '(' + n.replace(/\s+/g, ',').replace(/\.(\d)+(?=,)/g, '') + ')'
                      );
                  }
                };
              })();
  ...
  p(rb, ab, {
    handler: function (a) {
      ...
      b & O && 0 === a.button && (this.pressed = !0),
        b & P && 1 !== a.which && (b = Q),
        this.pressed && this.allow && (b & Q && (this.pressed = !1), this.callback(this.manager, b, { pointers: [a], changedPointers: [a], pointerType: L, srcEvent: a }));
    },
  });
    ...
    p(bc, ac, {
      ...
      directionTest: function (a) {
        var b = this.options,
          ...
          g = a.deltaY;
        return (
          e & b.direction || (b.direction & X ? ((e = 0 === f ? S : 0 > f ? T : U), (c = f != this.pX), (d = Math.abs(a.deltaX))) : ((e = 0 === g ? S : 0 > g ? V : W), (c = g != this.pY), (d = Math.abs(a.deltaY)))),
          (a.direction = e),
