!(function ($) {
  ...
  var ChatApp = function () {
    (this.$body = $('body')), (this.$chatInput = $('.chat-input')), (this.$chatList = $('.conversation-list')), (this.$chatSendBtn = $('.chat-send .btn'));
  };
  ...
  (ChatApp.prototype.save = function () {
    ...
    if (chatText == '') {
      ...
      $(
        '<li class="clearfix"><div class="chat-avatar"><img src="assets/images/users/avatar-1.jpg" alt="male"><i>' +
          chatTime +
